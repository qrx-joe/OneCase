...
当前使用 AI+民生个人参赛版 v2，不使用团队名称。材料入口见 [初赛提交说明](docs/competition/preliminary-2026/README.md)。Markdown 讲稿与邮件已同步 StepFun 接入边界；现有 PPTX、备注、PDF 和项目简介 Word 尚未同步本轮文字，发送前必须重新导出并逐份核对。姓名和电话留在报名资料及邮件中，不放入展示材料。邮件尚未发送，报名与资格仍需本人核实。
